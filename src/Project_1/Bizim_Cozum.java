...
public class Bizim_Cozum {
    public static void main(String[] args) {

        // Scanner class tanimlayin...
        Scanner input = new Scanner((System.in));

        // Kullanicidan ismini girmesini isteyin ve girilen ismin ilk harfini buyuk harfe donusturun...
        System.out.print("Lütfen adınızı giriniz : ");
        String isim = input.nextLine();
        isim=basHarfiBuyut(isim);
    ...
    public static String basHarfiBuyut(String gelenKelime){
        gelenKelime = gelenKelime.substring(0, 1).toUpperCase() + gelenKelime.substring(1).toLowerCase();
        return gelenKelime;
    }
